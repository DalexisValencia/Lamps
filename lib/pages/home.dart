...
class HomePageState extends State<HomePage>{
  ...
  final List<ProductsModel> products = List<ProductsModel>.generate(2, (i){
    var index = i+1;
    return ProductsModel(name: 'Theo $index', imageMain: 'assets/img-$index.png', thumbnail: 'assets/detail-$index.png');
    });
                  ...
                  return Builder(
                    builder: (BuildContext context){
                      return Container(
                        ...
                        child: ProductCard(name:product.name, thumbnail: product.thumbnail),
                        //child: ProductCard(),
                      ); 
                    }
                  );
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    onPressed: (){
                      Navigator.of(context).push(_createPage(DetailPageScaffold()));
                    },
                    shape: RoundedRectangleBorder(
...
Route _createPage(child){
  return PageRouteBuilder(
    pageBuilder: (BuildContext context, Animation animation, Animation secondaryAnimation) => child,
    transitionsBuilder: (BuildContext context, Animation animation, Animation secondaryAnimation, child){
      //return child;
